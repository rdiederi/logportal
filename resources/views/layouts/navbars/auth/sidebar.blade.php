...
<aside class="sidenav z-index-1 navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
{{-- <aside class="sidenav navbar-expand-xs border-0 border-radius-xl my-3" id="sidenav-main"> --}}
  <div class="sidenav-header d-flex justify-content-center ">
    <a class="align-items-center d-flex " href="{{ route('dashboard') }}">
        <img src="../assets/img/logos/Networds -Logo.png" class="h-100" alt="...">
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      <li class="nav-item d-flex text-center">
        <a class="nav-link  flex-fill {{ (Request::is('dashboard') ? 'active' : '') }}" href="{{ url('dashboard') }}">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-door-fill" viewBox="0 0 16 16">
            <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
          </svg>
          <span class="align-items-center nav-link-text ms-1"></i>Dashboard</span>
        </a>
      </li>
      <li class="nav-item d-flex text-center">
        <a class="nav-link  flex-fill {{ (Request::is('dashboard') ? 'active' : '') }}" href="{{ url('dashboard') }}">
          ...
          <span class="align-items-center nav-link-text ms-1"></i>Google Drive</span>
        </a>
      </li>
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Reporting & Analytics</h6>
      </li>
      <li class="nav-item d-flex text-center">
        <a class="nav-link  flex-fill {{ (Request::is('dashboard') ? 'active' : '') }}" href="{{ url('google-ads-dashboard') }}">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-google" viewBox="0 0 16 16">
            <path d="M15.545 6.558a9.42 9.42 0 0 1 .139 1.626c0 2.434-.87 4.492-2.384 5.885h.002C11.978 15.292 10.158 16 8 16A8 8 0 1 1 8 0a7.689 7.689 0 0 1 5.352 2.082l-2.284 2.284A4.347 4.347 0 0 0 8 3.166c-2.087 0-3.86 1.408-4.492 3.304a4.792 4.792 0 0 0 0 3.063h.003c.635 1.893 2.405 3.301 4.492 3.301 1.078 0 2.004-.276 2.722-.764h-.003a3.702 3.702 0 0 0 1.599-2.431H8v-3.08h7.545z"/>
          </svg>
          <span class="align-items-center nav-link-text ms-1"></i>Google Ads</span>
        </a>
      </li>
      <li class="nav-item">
